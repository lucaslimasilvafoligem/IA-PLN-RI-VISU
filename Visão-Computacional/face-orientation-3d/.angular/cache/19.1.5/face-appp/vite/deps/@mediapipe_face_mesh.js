      ...
      J("Promise", function(a) {
        ...
        b.prototype.B = function() {
          ...
          "function" === typeof f ? f = new f("unhandledrejection", {
            ...
            cancelable: true
          }) : (f = G.document.createEvent("CustomEvent"), f.initCustomEvent("unhandledrejection", false, true, f));
          f.promise = this;
          f.reason = this.i;
          return k(f);
        };
        ...
        if (b = b || this.g.options) {
          for (var d = [], e = [], g = {}, f = K(Object.keys(a)), h = f.next(); !h.done; g = {
            ...
            k in this.j && this.j[k] === a[k] || (this.j[k] = a[k], h = b[k], void 0 !== h && (h.onChange && (g.K = h.onChange, g.L = a[k], d.push(/* @__PURE__ */ function(l) {
              ...
              valueBoolean: 0 === h.type ? a[k] : false,
                    ...
                    switch (n.type) {
                      ...
                      case "detections":
                        ...
                        for (x = 0; x < t.length; ++x) {
                          ...
                          H = $a(H);
                          F.call(E, I, H);
                          if (z.O) for (E = 0; E < z.O.length; ++E) p = z.O[E], A = p.visibility ? true : false, F = m.data, I = F.addNormalizedLandmark, H = x, p = Object.assign(Object.assign({}, p), {
